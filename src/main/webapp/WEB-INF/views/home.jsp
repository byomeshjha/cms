    ...
    <script src="<c:url value="/assets/scripts/dashboard.js"/>"></script>
            ...
            <div class="row">
                <div class="col-lg-12">
                	<div class="page-header alert alert-info">
                    	<!--h4 class="page-header alert alert-info"><b>Dashboard</b></h4-->
                   		<i class="fa fa-folder-open"></i><b>&nbsp;Dashboard! </b>Welcome Back <b>${LOGGEDIN_USER.firstName} ${LOGGEDIN_USER.lastName} </b>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-list-alt fa-fw"></i>  Active Case List
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped" id="active-case-list">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
									                <th>Case Name</th>
